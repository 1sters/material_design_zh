...
* 虽然UI元素是有形的，但是他们被限制在屏幕里面，而可视化的动画效果填补了空缺，让用户感觉与UI的交互更直接
...
<span style="background-color:#48B04B" width="360" height="30" ><font color="#48B04B">==============================================</font></span>
<font color="#48B04B"><b>正确</b></font>
...
<span style="background-color:#F7412D" width="360" height="30"><font color="#F7412D">==============================================</font></span>
**错误**
物体从屏幕正中央出现，用户无法把点击和物体联系上


#####点击浮动


独立的小控件在激活的时候 应该浮起以表明进入激活状态。
...
所有的用户行为都会有一个中心点。作为用户关注的中心区域，应该绘制一个明显的可视化图形来与用户输入（触摸屏幕、语音输入等）产生联系。应该形成一个逐渐远离中心店的动画，就像涟漪一样。


所有输入都有中心点，触摸时的点击位置，语音时屏幕上的语音图标位置，键盘输入时具体的按键点击位置。
